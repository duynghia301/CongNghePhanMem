...
import { Attachment, House } from "@prisma/client";
import { useForm, SubmitHandler } from "react-hook-form";
import { zodResolver } from "@hookform/resolvers/zod";
import { FileUpload } from "@/app/components/file-upload";

interface AttachmnetFormProps {
    initialData: House &{ attachments:Attachment[]};
    houseId: string;
}
...
export const AttachmnetForm = ({ initialData, houseId }: AttachmnetFormProps) => {
    ...
    const onSubmit: SubmitHandler<FormSchemaType> = async (values) => {
        try {
            await axios.post(`/api/houses/${houseId}/attachments`, values);
    ...
    const onDelete = async (id:string)=>{
        try {
            setDeleting(id);
            await axios.delete(`/api/houses/${houseId}/attachments/${id}`);
